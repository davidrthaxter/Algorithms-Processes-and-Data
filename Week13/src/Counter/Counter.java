...
{
    /**
     * Each counter will have a name to identify it in its trace
     **/
    private String name;
    ...
    */
    ...
    public void startCount() {
        counter = from;
        if (tracingOn) System.out.println(name + " has started: " + counter);
    }
    ...
    public void stepCount() {
        delay();
        counter += step;
        if (tracingOn) System.out.println(name + " has stepped: " + counter);
    }
    ...
    public boolean isFinished() {
        ...
        if (tracingOn && finished) System.out.println(name + " has finished: " + counter);
        return finished;
    }
}
